...
raw_dir = "research/data/raw/dblp_acm/"
zip_file = raw_dir + "data-2022-10-04T15:16:18.262-03:00.zip"
...
output_dir = output_dir / "dblp_acm"
output_dir.mkdir(parents=True, exist_ok=True)
...
matches["idACM"] = "id_B-" + matches["idACM"].astype(str)
...
idB_counted = matches["idACM"].value_counts()
...
matches = matches[~matches["idACM"].isin(duplicate_B_ids)]
...
for B_id in B_ids:
    ...
    B_match = matches[matches["idACM"] == B_id]
